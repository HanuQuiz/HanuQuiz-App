 ...
 */
function bindQuestionButtons(el, options) {
    if (!options) options = {};
...
function bindQuestionCreationButton(el) {
    // Link create button
    el.find('.js-question-create').click(function(e) {
        e.preventDefault();

        $("body").ufModal({
            sourceUrl: site.uri.public + "/modals/question/create",
            msgTarget: $("#alerts-page")
        });
