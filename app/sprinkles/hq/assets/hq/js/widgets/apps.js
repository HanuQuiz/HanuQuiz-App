 ...
 */
function bindAppButtons(el, options) {
    if (!options) options = {};
    ...
    el.find('.js-app-edit').click(function(e) {
        ...
        $("body").ufModal({
            sourceUrl: site.uri.public + "/modals/apps/edit",
            ajaxParams: {
                slug: $(this).data('slug')
            },
    ...
    el.find('.js-app-delete').click(function(e) {
        ...
        $("body").ufModal({
            sourceUrl: site.uri.public + "/modals/apps/confirm-delete",
            ajaxParams: {
                slug: $(this).data('slug')
            },
            msgTarget: $("#alerts-page")
...
function bindAppCreationButton(el) {
    // Link create button
    el.find('.js-app-create').click(function(e) {
        e.preventDefault();

        $("body").ufModal({
            sourceUrl: site.uri.public + "/modals/apps/create",
            msgTarget: $("#alerts-page")
        });
