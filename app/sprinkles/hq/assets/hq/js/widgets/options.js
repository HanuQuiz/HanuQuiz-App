 ...
 */
function attachQuestionOptionForm() {
 ...
 */
function bindOptionButtons(el, options) {
    if (!options) options = {};
    ...
    el.find('.js-option-edit').click(function(e) {
        e.preventDefault();
        ...
        attachQuestionOptionForm();
    });

    // Delete group button
    el.find('.js-option-delete').click(function(e) {
        e.preventDefault();
...
function bindOptionCreationButton(el) {
    // Link create button
    el.find('.js-option-create').click(function(e) {
        e.preventDefault();
